...
pruebasInitPropagar(CELDA cuadricula[NUM_FILAS][NUM_COLUMNAS], char init, char propagar)
{
    ...
    switch (propagar) {
        ...
        case 'A': // ARM
        sudoku_candidatos_propagar_arm(cuadricula, fila, columna);
        break;
...
/*
void
sudoku9x9_arm(CELDA cuadricula[NUM_FILAS][NUM_COLUMNAS], char *ready)
{
    int celdas_vacias;     //numero de celdas aun vacias
...
void
sudoku9x9_thumb(CELDA cuadricula[NUM_FILAS][NUM_COLUMNAS], char *ready)
{
    int celdas_vacias;     //numero de celdas aun vacias

    celdas_vacias = sudoku_candidatos_init_thumb(cuadricula);
}
*/
